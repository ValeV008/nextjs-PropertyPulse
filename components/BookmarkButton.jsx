'use client'; // because we use event handlers and hooks
...
const BookmarkButton = ({property}) => {
    ...
    if (loading)
        return <p className="bg-blue-500 hover:bg-blue-600 text-white font-bold w-full py-2 px-4 rounded-full flex items-center justify-center">
            Loading ...
        </p>
